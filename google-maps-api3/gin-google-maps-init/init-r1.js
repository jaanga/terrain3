...
//		return COR.getMenuDetailsObjectProperties( COR.place );

		return getMenuDetailsAPIKeyInit() +
			getMenuDetailsMapClickInit();
	...
	function initGoogleMapInit() {
		...
		mapDiv.id = 'mapDiv';
		hamburger.style.zIndex = menu.style.zIndex = 1;
