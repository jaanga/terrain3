...
//	var defaultFile = 'https://jaanga.github.io/terrain3/elevations-data/elevations-data-03/tenzing-hillary-airport-lukla-nepal_12_3033_1718_3_4_510_680_.txt';
...
//	var searchInFolder = 'elevations-data-family+friends/';
	...
	var urlBase = 'https://jaanga.github.io/terrain3/elevations-data/' + searchInFolder;
//	var urlBase = '../elevations-data-03/' + searchInFolder;
	...
	function initMapViewMenu() {
		...
		if ( location.hash && location.hash.match( 'cat=' ) ) {
			...
			urlBase = 'https://jaanga.github.io/terrain3/elevations-data/' + searchInFolder;
