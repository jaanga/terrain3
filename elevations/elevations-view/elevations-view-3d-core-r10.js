...
// inits
	...
	function setMenuDetailsOverlay() {
		...
		selMapZoom.selectedIndex = deltaDefault;
...
//		map.max = arrayMax( map.elevations );
		...
		deltaLatTile = deltaLat / map.tilesY;
	...
	function initMapGeometry() {
		...
		map.geometry = new THREE.PlaneBufferGeometry( deltaLatTile * map.tilesX, deltaLatTile * map.tilesY, map.segmentsX - 1, map.segmentsY - 1 );
